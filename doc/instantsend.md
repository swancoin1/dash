...
This mechanism has been integrated into Bitcore-Node-Mewcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/swancoin1/insight-api-mewcoin#web-socket-api](https://github.com/swancoin1/insight-api-mewcoin#web-socket-api)
* API: [https://github.com/swancoin1/insight-api-mewcoin#instantsend-transactions](https://github.com/swancoin1/insight-api-mewcoin#instantsend-transactions)
...
By default, the Mewcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Mewcoin Core daemon:
