...
Mewcoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Mewcoin Core, where everyone uses
...
pay attention to for reviewers of Mewcoin Core code.

General Mewcoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Mewcoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
