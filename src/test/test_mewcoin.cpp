...
#define BOOST_TEST_MODULE Mewcoin Test Suite

#include "test_mewcoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_mewcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
