...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "MewcoinNetwork") type = MewcoinNetwork;
    if(strType == "MewcoinNetworkVariable") type = MewcoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == MewcoinNetwork) s = "MewcoinNetwork";
    if(type == MewcoinNetworkVariable) s = "MewcoinNetworkVariable";
