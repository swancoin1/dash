 ...
 *
 *   // network
 *   CMewcoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.mewcoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CMewcoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CMewcoinNetwork(UniValue objIn)
    {
...
// // can be under: MewcoinNetwork
// //   -- signature requirements : Key1(User)
// class CMewcoinNetworkVariable : public CGovernanceObject
// {
// private:
