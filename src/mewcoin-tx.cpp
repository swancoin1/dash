...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Mewcoin Core mewcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  mewcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mewcoin transaction") + "\n" +
              "  mewcoin-tx [options] -create [commands]   " + _("Create hex-encoded mewcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mewcoin transaction
