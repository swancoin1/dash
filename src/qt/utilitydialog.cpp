    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Mewcoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Mewcoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  mewcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Mewcoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 MEWCOIN, 0.1 MEWCOIN, 1 MEWCOIN and 10 MEWCOIN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://swancoin1.atlassian.net/wiki/display/DOC/PrivateSend\">https://swancoin1.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Mewcoin Core is shutting down...") + "<br /><br />" +
