    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("MEWCOIN-light"), QVariant("light"));
    ui->theme->addItem(QString("MEWCOIN-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("MEWCOIN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("MEWCOIN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("MEWCOIN-traditional"), QVariant("trad"));
